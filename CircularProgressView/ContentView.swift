...
/*
 ...
 @State var lineWidth: CGFloat = 8
 /// Right to left or left to right progressing.
 @State var rightToLeft: Bool = true
 /// Clockwise or pod-clockwise drawing.
 @State var isClockwise: Bool = false
 /// Starting and ending angles of the bigger gray stroke.
 var angles: (start: Angle, end: Angle) {
 ...
 /// The angle at which the little circle is drawn. (the green circle)
 var circleAngle: Angle {
 let value1 = progressedAngle + angles.start
 let value2 = angles.end - progressedAngle
 switch rightToLeft {
 case true:
 switch isClockwise {
 case true: return value2
 case false: return value1
 }
 case false:
 switch isClockwise {
 case true: return value1
 case false: return value2
 }
 }
 }
 /// The angles for the progress arc. (the blue arc)
 var progressAngles: (start: Angle, end: Angle) {
 let value1 = (start: angles.start, end: circleAngle)
 let value2 = (start: circleAngle, end: angles.end)
 switch rightToLeft {
 case true:
 switch isClockwise {
 case true: return value2
 ...
 Button("is clockwise: \(isClockwise.description)") {
 isClockwise.toggle()
 }
 }
 .font(.headline)
